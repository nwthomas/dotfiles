...
# This script accepts one command (e.g. bash backup-file.sh <file-name>) and backs it up
# to a /tmp directory locally. This can be used prior to making complex modifications
# that might require a revert.
